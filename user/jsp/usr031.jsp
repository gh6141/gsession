...
<td width="100%" align="center">
  ...
  <td align="left">
    ...
    <td valign="middle" align="left" class="td_wt6" width="100%" colspan="1">
      ...
      <span class="text_base">*<gsmsg:write key="user.usr031.8" /><br/>- ! # $ % & . / = @ | _ * ' + ? ^ ` { } ~</span>
      <logic:notEqual name="usr031Form" property="processMode" value="kojn_edit">
      <div id="usr031UsrUkoFlg_warn" style="display: none;"><span class="text_r1">※<gsmsg:write key="user.usr031kn.12" /></span></div>
      </logic:notEqual>
    </td>
    <td valign="top" align="left"  class="td_wt7" nowrap>
      <logic:notEqual name="usr031Form" property="processMode" value="kojn_edit">
        <table cellpadding="5" cellspacing="0" border="0" width="100%" class="tl_u2">
         <tr>
            <td valign="middle" align="center" class="table_bg_A5B4E1" width="100%" nowrap>
              <span class="text_bb1"><gsmsg:write key="cmn.status" /></span>
            </td>
         </tr>
         <tr>
            <td valign="middle" align="center" class="td_wt" width="100%" >
              <div class="text_base">
              <html:checkbox styleId="usr031UsrUkoFlg" name="usr031Form" property="usr031UsrUkoFlg" value="1" onclick="dspChangeUsrUko();"/><label for="usr031UsrUkoFlg"><gsmsg:write key="user.usr031.21" /></label>
              </div>
            </td>
         </tr>
       </table>
    ...
    <td valign="middle" align="left" class="td_wt6"><html:text property="usr031mail1"  styleClass="input_mail"  maxlength="256" />&nbsp;
    ...
    <td valign="middle" align="left" class="td_wt6"><html:text property="usr031mail2"  styleClass="input_mail"  maxlength="256" />&nbsp;
    ...
    <td valign="middle" align="left" class="td_wt6"><html:text property="usr031mail3"  styleClass="input_mail"  maxlength="256" />&nbsp;
