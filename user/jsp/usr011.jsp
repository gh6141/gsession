...
<td width="100%" align="center" cellpadding="5" cellspacing="0">
  ...
  <td align="left">
    ...
    <td valign="middle" align="left" class="td_type1" width="100%"><html:text property="usr011gpId" style="width:541px;" maxlength="50" /></td>
    </tr>
        ...
        <select size="17" multiple name ="users_l" class="select01">
          <logic:notEmpty name="usr011Form" property="usr011tarBelongingUser" scope="request">
            <logic:iterate id="ulBean" name="usr011Form" property="usr011tarBelongingUser" scope="request">
              <option class=" <logic:equal name="ulBean" property="usrUkoFlg" value="1" >mukouser_option</logic:equal>" value="<bean:write name="ulBean" property="usrsid" scope="page"/>"><bean:write name="ulBean" property="fullName" scope="page"/></option>
            </logic:iterate>
          </logic:notEmpty>
        ...
        <select size="14" multiple name="users_r" class="select01">
          <logic:notEmpty name="usr011Form" property="usr011tarUnbelongingUser" scope="request">
            <logic:iterate id="urBean" name="usr011Form" property="usr011tarUnbelongingUser" scope="request">
              <option class=" <logic:equal name="urBean" property="usrUkoFlg" value="1" >mukouser_option</logic:equal>" value="<bean:write name="urBean" property="usrsid" scope="page"/>"><bean:write name="urBean" property="fullName" scope="page"/></option>
            </logic:iterate>
          </logic:notEmpty>
          <option value="-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
        </select>
        ...
        <select size="15" multiple name ="usersKr_l" class="select01">
          <logic:notEmpty name="usr011Form" property="usr011BelongingUserKr" scope="request">
            <logic:iterate id="ulkrBean" name="usr011Form" property="usr011BelongingUserKr" scope="request">
              <option class=" <logic:equal name="ulkrBean" property="usrUkoFlg" value="1" >mukouser_option</logic:equal>" value="<bean:write name="ulkrBean" property="usrsid" scope="page"/>"><bean:write name="ulkrBean" property="fullName" scope="page"/></option>
            </logic:iterate>
          </logic:notEmpty>
          <option value="-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
        </select>
...
--%>
        ...
        <select size="15" multiple name ="usersKr_r" class="select01">
          <logic:notEmpty name="usr011Form" property="usr011UnBelongingUserKr" scope="request">
            <logic:iterate id="uripBean" name="usr011Form" property="usr011UnBelongingUserKr" scope="request">
              <option class=" <logic:equal name="uripBean" property="usrUkoFlg" value="1" >mukouser_option</logic:equal>" value="<bean:write name="uripBean" property="usrsid" scope="page"/>"><bean:write name="uripBean" property="fullName" scope="page"/></option>
            </logic:iterate>
          </logic:notEmpty>
          <option value="-1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
        </select>
    ...
    <span class="text_r1"><gsmsg:write key="user.usr011.4" /></span>
