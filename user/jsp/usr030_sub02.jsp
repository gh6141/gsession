...
<%@ taglib uri="/WEB-INF/ctag-message.tld" prefix="gsmsg" %>
      ...
      <td width="50%" valign="top">
        ...
        <td class="user_search2_syosai_td_1" align="left" width="80%">
          <html:text property="usr030userId" style="width:273px;" maxlength="20" /> <br />
          <span class="text_base">
          <gsmsg:write key="cmn.status"/>:
          <html:radio property="usr030usrUkoFlg" styleId="usr030usrUkoFlg_0" value="-1" /><label for="usr030usrUkoFlg_0"><gsmsg:write key="ntp.166" /></label>
          <html:radio property="usr030usrUkoFlg" styleId="usr030usrUkoFlg_1" value="0" /><label for="usr030usrUkoFlg_1"><gsmsg:write key="user.usr030.4" /></label>
          <html:radio property="usr030usrUkoFlg" styleId="usr030usrUkoFlg_2" value="1" /><label for="usr030usrUkoFlg_2"><gsmsg:write key="user.usr030.5" /></label>
          </span>
        </td>
        ...
        <td class="user_search2_syosai_td_1" align="left">
          <html:text property="usr030mail" style="width:273px;" maxlength="<%= String.valueOf(GSConstUser.MAX_LENGTH_MAIL) %>" /></td>
