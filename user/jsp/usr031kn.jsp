...
<script language="JavaScript" src="../user/js/usr031kn.js?<%= GSConst.VERSION_PARAM %>"></script>
...
<td align="left">
  ...
  <td width="100%" class="header_ktool_bg_text2">
    ...
    <logic:equal name="usr031knForm" property="processMode"  scope="request" value="yuko">[ <gsmsg:write key="user.usr031kn.8" /> ]</logic:equal>
    <logic:equal name="usr031knForm" property="processMode"  scope="request" value="muko">[ <gsmsg:write key="user.usr031kn.9" /> ]</logic:equal>
  </td>
  ...
  <td class="header_glay_bg" width="50%">
    <logic:equal name="usr031knForm" property="processMode"  scope="request" value="add">
      <input type="button" value="<gsmsg:write key="cmn.final" />" class="btn_base1" onClick="buttonPush('add');">
    </logic:equal>
    <logic:equal name="usr031knForm" property="processMode"  scope="request" value="edit">
      <input type="button" value="<gsmsg:write key="cmn.final" />" class="btn_base1" onClick="buttonPush('edit');">
    </logic:equal>
    ...
    <logic:equal name="usr031knForm" property="processMode"  scope="request" value="yuko">
      <input type="button" name="btn_add" class="btn_base1" value="<gsmsg:write key="cmn.ok" />" onClick="return buttonPush('usr031kn_yuko');">
    </logic:equal>
    <logic:equal name="usr031knForm" property="processMode"  scope="request" value="muko">
      <input type="button" name="btn_add" class="btn_base1" value="<gsmsg:write key="cmn.ok" />" onClick="return buttonPush('usr031kn_muko');">
    </logic:equal>
  ...
  <table id="usr031FormTable" cellpadding="5" cellspacing="0" border="0" width="100%" class="tl_u2">
  ...
  <!-- ユーザID -->
  <td valign="middle" align="left" class="td_wt6" width="100%" colspan="1">
    ...
    <logic:equal name="usr031knForm" property="usr031UsrUkoFlg" value="1">
      <br />
      <span class="text_r1">※<gsmsg:write key="user.usr031kn.12" /></span>
    </logic:equal>
    </logic:notEqual>
  </td>
  <td valign="top" align="left" class="td_wt7" width="100%" >
    <logic:equal name="usr031knForm" property="usr031UsrUkoFlg" value="1">
       <div class="text_r1"><gsmsg:write key="cmn.status" />:<gsmsg:write key="user.usr031.21" /></dir>
    </logic:equal>
  </td>
  </tr>
  ...
  <tr>
  <td valign="middle" align="left" class="table_bg_A5B4E1" width="0%" colspan="2" nowrap>
    <span class="text_bb1"><gsmsg:write key="user.usr031.22" /></span>
  </td>
  <td valign="middle" align="left" class="td_wt" width="100%" colspan="2">
   <html:hidden name="usr031knForm" property="usr031OtpToAddress" />
  <span class="text_base"><bean:write name="usr031knForm" property="usr031OtpToAddress" /></span>
  </td>
  </tr>
  </logic:equal>
