...
<td width="100%" align="center">
  ...
  <td>
    ...
    <td align="left" class="td_type1" width="80%"><bean:write name="ptl120knForm" property="ptl120name" />
    </td>
    </tr>
    <tr>
    <td class="table_bg_A5B4E1" width="20%" nowrap><span class="text_bb1"><gsmsg:write key="cmn.memo" /></span></td>
    <td align="left" class="td_type1" width="80%"><bean:write name="ptl120knForm" property="ptl120biko" />
    </td>
    </tr>
    </table>
