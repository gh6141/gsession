...
<td width="100%" align="center">
  ...
  <td>
    ...
    <table id="normal_settings"  width="100%" class="tl0 " cellpadding="5">

    <tr>
    <th width="15%" class="table_bg_A5B4E1 " align="left"  nowrap><span class="text_bb1"><gsmsg:write key="main.man500.3" /></span></th>
    <td class="td_wt">
    ...
    <tr>
    <th width="15%" class="table_bg_A5B4E1 " align="left"  nowrap><span class="text_bb1"><gsmsg:write key="main.man500.4" /></span></th>
    <td class="td_wt">
      <span class="text_base">
    ...
    <tr>
    <th  width="15%" class="table_bg_A5B4E1"  align="left" nowrap>
