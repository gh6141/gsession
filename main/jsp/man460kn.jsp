...
<html:form action="/main/man460kn">
...
<td width="100%" align="center" cellpadding="5" cellspacing="0">
  ...
  <td align="left">
    ...
    <td width="100%" class="header_ktool_bg_text2">[ <gsmsg:write key="main.man460kn.1" /> ]</td>
    ...
    <td class="header_glay_bg" width="50%">
      <input type="button" name="btn_add" class="btn_base1" value="<gsmsg:write key="cmn.run" />" onClick="buttonPush('Man460kn_Import');">
      <input type="button" name="btn_back" class="btn_back_n1" value="<gsmsg:write key="cmn.back" />" onClick="buttonPush('Man460kn_Back');">
    </td>
    ...
    <td valign="middle" align="left" class="td_nrlb" width="100%">
      <span class="text_base"><bean:write name="man460knForm" property="man460knFileName" /></span>
    </td>
    </tr>
    ...
    <td valign="middle" align="left" class="td_nrlb" width="100%">
      <span class="text_base"><bean:write name="man460knForm" property="man460knImpCount" /><gsmsg:write key="cmn.number" /></span><br>
    </td>
    </tr>
