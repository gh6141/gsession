...
<td width="100%"" align="center">
  ...
  <tr>
  <td>
    <table cellpadding="10" cellspacing="0" border="0" class="tl_u2" width="100%">
    ...
    <tr>
    <th  valign="middle" align="left" class="table_bg_A5B4E1" width="15%" nowrap>
      <span class="text_bb1"><gsmsg:write key="user.usr060.4" /></span><span class="text_r2"><gsmsg:write key="cmn.comments" /></span>
    </th>
    <td valign="middle" align="left" class="td_wt" >
      <html:radio name="man500Form" styleId="manOtpAddressKbn_01" property="man500OtpAddressKbn" value="<%= String.valueOf(jp.groupsession.v2.man.GSConstMain.OTPTOADDRES_EDIT_ADM) %>" /><label for="manOtpAddressKbn_01"><span class="text_base"><gsmsg:write key="cmn.set.the.admin" /></span></label>&nbsp;
      <html:radio name="man500Form" styleId="manOtpAddressKbn_02" property="man500OtpAddressKbn" value="<%= String.valueOf(jp.groupsession.v2.man.GSConstMain.OTPTOADDRES_EDIT_USER) %>" /><label for="manOtpAddressKbn_02"><span class="text_base"><gsmsg:write key="cmn.set.eachuser" /></span></label>
    </td>
    </tr>
    </table>
