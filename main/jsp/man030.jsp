    ...
    <td width="49%" valign="top">
      ...
      <dd>
        ...
        <li class="text">
          ...
          <br><span class="text_indent_22">・・・<gsmsg:write key="user.usr060.2" /></span>
        </li>
        </logic:equal>
        ...
        <li class="text">
          <img src="../main/images/icon_import_cyb.gif" class="img_border" alt="<gsmsg:write key="main.man490.1" />">
          <a href="#" onClick="return buttonPush('cybozu');"><span class="text_link"><gsmsg:write key="main.man490.1" /></span></a>
          <br><span class="text_indent_22">・・・<gsmsg:write key="main.man490.2" /></span>
