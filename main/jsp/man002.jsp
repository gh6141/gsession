  ...
  <td align="left">
    ...
    <td valign="top" width="49%">
      ...
      <dd>
       ...
       <tr>
        ...
        <tr>
        <td align="right">
          <span class="text_bb1"><gsmsg:write key="main.man002.101" />：</span>
        </td>
        <td style="border:1px;border-bottom-style:solid;border-color:#cccccc;">
          <logic:empty name="man002Form" property="licenseId">&nbsp;</logic:empty>
            <span class="text_gray"><bean:write name="man002Form" property="licenseEntry" /></span>
        </td>
        </tr>
        </logic:notEmpty>
        ...
        <td style="border:1px;border-bottom-style:solid;border-color:#cccccc;">
        <span class="text_gray"><gsmsg:write key="cmn.period2" />&nbsp;</span>
        ...
        <span style="font-size:90%;color:#CC3333;">
        <bean:write name="plugin" property="licenseLimit" />
        <img src="../common/images/keikoku.gif" alt="<gsmsg:write key="cmn.warning" />" style="vertical-align:top;">
        </logic:equal>

        <logic:equal name="plugin" property="licenseOverFlag" value="-1">
        <span class="text_gray" style="background-color:#dedede">
        <bean:write name="plugin" property="licenseLimit" />
    ...
    <td width="49%" valign="top">
      ...
      <dd>
        ...
        <logic:notEqual name="man002Form" property="sysKbn" value="1">
          <li class="text">
            <img src="../main/images/icon_syain.gif" class="img_border" alt="<gsmsg:write key="main.man420.2" />">
            <a href="#" onClick="return buttonPush('linkTime');"><span class="text_link"><gsmsg:write key="main.man420.2" /></span></a>
            <br><span class="text_indent_22">・・・<gsmsg:write key="main.man002.77" /></span>
          </li>
        </logic:notEqual>

        <li class="text">
          <img src="../main/images/icon_import_cyb.gif" class="img_border" alt="<gsmsg:write key="cmn.import.cybozu" />">
          <a href="#" onClick="return buttonPush('cybozuImport');"><span class="text_link"><gsmsg:write key="cmn.import.cybozu" /></span></a>
          <br><span class="text_indent_22">・・・<gsmsg:write key="main.man440.20" /></span>
          <br><span class="text_base_mini"><gsmsg:write key="main.man440.21" /></span>
        </li>
      ...
      <dd>
        ...
        <%-- ワンタイムパスワード設定--%>
        <li class="text">
          <img src="../main/images/icon_loginconf.gif" class="img_border" alt="<gsmsg:write key="main.man510.1" />">
          <a href="#" onClick="return buttonPush('otpConf');"><span class="text_link"><gsmsg:write key="main.man510.1" /></span></a>
          <br><span class="text_indent_22">・・・<gsmsg:write key="main.man510.2" /></span>
        </li>
        </logic:equal>
        <li class="text">
          <img src="../main/images/icon_passward.gif" class="img_border" alt="<gsmsg:write key="main.externalpage" />">
          <a href="#" onClick="return buttonPush('externalPage');"><span class="text_link"><gsmsg:write key="main.externalpage" /></span></a>
          <br><span class="text_indent_22">・・・<gsmsg:write key="main.man002.110" /></span>
        </li>
      </dd>
      </dl>
      ...
      <%-- adminユーザ設定 --- --%>
      <dl class="decorate_textbox2">
      <dt><img src="../main/images/icon_batch.gif" class="img_border" alt="<gsmsg:write key="main.man002.111" />"><gsmsg:write key="main.man002.111" /></dt>
      <dd>
        <li class="text">
          <img src="../main/images/icon_passward.gif" border="0" alt="<gsmsg:write key="cmn.change.password" />">
          <a href="#" onClick="return buttonPush('password');"><span class="text_link"><gsmsg:write key="cmn.change.password" /></span></a>
          <br><span class="text_indent_22">・・・<gsmsg:write key="main.man002.70" /></span>
        </li>
        <logic:equal name="man002Form" property="useableOtp" value="<%= String.valueOf(jp.groupsession.v2.man.GSConstMain.OTP_USE) %>">
        <li class="text">
          <img src="../main/images/icon_passward.gif" border="0" alt="<gsmsg:write key="user.usr060.1" />">
          <a href="#" onClick="return buttonPush('otp_sendto_address');"><span class="text_link"><gsmsg:write key="user.usr060.1" /></span></a>
          <br><span class="text_indent_22">・・・<gsmsg:write key="user.usr061.2" /></span>
        </li>
        </logic:equal>
      </dd>
      </dl>
