...
<div id="login_box">
    ...
    <div id="tutorial">
      <div style="background-image:url(../common/images/login/opt_icon_tutorial.gif); background-repeat: no-repeat; padding-left: 30px; height:20px;">
        <a href="https://groupsession.jp/support/tutorial.html" target="_blank" class="link_style"><gsmsg:write key="cmn.cmn001.6" /></a>
      </div>
    </div>

    <div id="login_options">
      <div style="background-image:url(../common/images/login/opt_icon_mobile.gif); background-repeat: no-repeat; padding-left: 30px;">
        <a href="https://groupsession.jp/products/gs_free.html#gsmobile" target="_blank" class="link_style"><gsmsg:write key="cmn.cmn001.7" /></a>
      </div>
...
<div id="footer_login" >
  <div id="footer_links">
    ...
    <a href="https://groupsession.jp/products/app.html" target="_blank"><img src="../common/images/login/link_appli.png" border="0" alt="<gsmsg:write key="cmn.appli" />"></a>
  </div>
  <div>
