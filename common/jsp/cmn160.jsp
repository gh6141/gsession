...
<td width="100%" align="center">
  ...
  <td align="left">
    ...
    <input type="button" class="btn_delete" value="<gsmsg:write key="cmn.delete" />" name="dellBtn" onClick="buttonPush('defaultLogo');">
    ...
    <tr>
    <td width="100%" align="left">
    <input type="button" class="btn_delete" value="<gsmsg:write key="cmn.delete" />" name="dellBtn" onClick="buttonPush('defaultMenuLogo');">
