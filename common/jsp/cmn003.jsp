...
<span>
  <logic:equal name="cmn003Form" property="cmn003LogoBinSid" value="0">
    <div><a href="<%= gsurl %>" target="body" border="0"  class="menu_evt gs-logo">GroupSession</a></div>
    <div><a href="<%= gsurl %>" target="body" border="0"  class="menu_evt gs-logo2">GroupSession</a></div>
  </logic:equal>
  <logic:notEqual name="cmn003Form" property="cmn003LogoBinSid" value="0">
    <div><a href="<%= gsurl %>" target="body" border="0"  style="background-image:url(../common/cmn003.do?CMD=getLogoImageFile&cmn003LogoBinSid=<bean:write name="cmn003Form" property="cmn003LogoBinSid" />);" class="menu_evt gs_user_logo">GroupSession</a></div>
    <div><a href="<%= gsurl %>" target="body" border="0"  class="menu_evt gs-logo2">GroupSession</a></div>
  </logic:notEqual>
</span>
